const creditsText = [
"Patrick McKeown: Project lead, core gameplay, custom level editor, collisions, lorry/truck ending sequence, slow tiles, UI, main tile art including grass and pens, call effects, tutorial, obstacles and characters, level design, scoring, mobile/tablet support, menus, automated tests, game event feedback effects, many bug fixes, additional sounds (includng barks, waterfowl)",
...
"Vince McKeown: Lorry/truck art, hat art, level time display",
"Gonzalo Delgado: Rogue dog sprite, UI button graphic with integration",
"FightEXP: Goal tile",
